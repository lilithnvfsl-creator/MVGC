...
parser.add_argument('--mvgc_model', default='mvgc_m', type=str, metavar='MODEL',
                help='Name of model to train (default: "mvgc_m")')
parser.add_argument(
...
print(args)
print("\n mvgc_model = " + str(args.mvgc_model))
